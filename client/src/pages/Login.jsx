        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6" style={{ position: 'relative' }}>
            <div className="relative z-10 w-full max-w-xs">
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="font-serif-brand text-2xl font-semibold text-white/70 tracking-wide">Welcome back</h1>
                    <p className="text-white/25 text-xs mt-1.5 tracking-wide">sign in to continue</p>
                </div>
                ...
                <p className="text-center text-white/20 text-xs mt-7">
                    No account?{' '}
                    <Link to="/register" className="text-purple-400/60 hover:text-purple-300 transition-colors">
                        Create one
                    </Link>
                </p>
            </div>
